...
export const SUBJECTS = [
  ...
  /* The two mountain subjects are 1330 m further up-valley than they were.
     ...
     also longer now. */
  {id:'aoraki',title:'奥拉基／库克山',group:'山岳',hint:'沿湖向北，把最远雪峰放入取景框。',text:'奥拉基从南阿尔卑斯主脊升起，是湖面视线的终点。',at:{kind:'point',x:-597,y:1450,z:-9980},radius:520,idealFill:.25,range:[6400,11000],up:0},
  {id:'alps-layers',title:'南阿尔卑斯层峦',group:'山岳',hint:'从路线望向湖首，寻找蓝灰色重叠山脊。',text:'空气透视把三层山体依距离洗向天空色。',at:{kind:'point',x:650,y:430,z:-5080},radius:470,idealFill:.36,range:[2800,5900],up:0},
